...
const db = require('../utils/db'); // Needed for Destination Check
...
const setupServer = (bot) => {
    ...
    // 1. API Endpoint for Logs (Used by Terminal)
    ...
    app.all('/api/trigger', async (req, res) => {
        ...
        try {
            ...
            // This checks if you set a custom group using /set_destination
            ...
            const mockCtx = {
                ...
                chat: { id: targetId }, // Send to Target
                message: { text: url, message_id: 0, from: { id: config.ADMIN_ID } },
                
                // Map Bot Functions to Target ID
